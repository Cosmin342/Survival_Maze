    ...
    class Camera
    {
     public:
        ...
        void RotateFirstPerson_OX(float angle)
        {
            ...
            //Se va roti cu unghiul angle pe axa Ox reprezentata de right
            forward = glm::normalize(glm::rotate(glm::mat4(1.0f), angle, right) * glm::vec4(forward, 1));
            //Se va muta si up, el calculandu-se utilizand cross
            up = glm::normalize(glm::cross(right, forward));
        }

        //Analog pentru celelalte rotatii la FirstPerson
        ...
        void RotateThirdPerson_OX(float angle)
        {
            ...
            /*
            La ThirdPerson, camera se va translata in punctul de interes, se va aplica o rotatie FirstPerson,
            iar apoi se va translata la loc
            */
